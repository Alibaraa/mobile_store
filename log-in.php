        ...
        <div class="col-lg-12 col-sm-12">
          ...
          <form dir="rtl" style="margin-right: 10px;" method="POST">
            <div class="form-group" >
              ...
              <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="اسم المستخدم" name="email">
         <!--     <small id="emailHelp" class="form-text text-muted">لن نشارك المعلومات مع احد</small>
            ...
            <div dir="rtl"><a href="register.php" style="text-decoration: none;">إنشاء حساب جديد</a></div>
          </form>
        ...
        if(isset($_POST['log-in'])){
          ...
          $result = mysqli_query($connection,$sql);
              while($res=mysqli_fetch_assoc($result)){
                ...
                $user_id = $res['id'];
                  echo "<script>window.location.href='users/index.php?id= $user_id '</script>";
              }
                  echo "<br>";
