          ...
          $myid =$_GET['id'];
             ...
             while($row = mysqli_fetch_assoc($result)){
              ...
              <center>   <img class="timg" src="../img/'.$row['image'].'" alt=""></center>
                <hr>
                <div style="heigh: 250px ;background-color: #212529; color:#ffffff;font-size: 24px;">
                <center>
...
<input type="submit" value="أضف الى السلة" class="btn btn-warning" name="add-product"  id="submit-btn" >
      ...
      <?php
       ...
       echo "<br>";
          ...
          if(isset($_POST['add-product'])){
            $sql = "insert into item_user(user_id,item_id) VALUES ('$user_id', '$product_id')";
