...
<body>
    ...
    $sql4 ="select * from user where id='$myid'";
    ...
    <nav class="navbar navbar-expand-lg bg-light" dir="rtl">
        ...
        <div style="width: 20px;"></div>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <a href="logout.php" style="text-decoration: none; color: #ffffff;">تسجيل الخروج</a>
            <!--
...
$resultsPerPage = 9;
//     $numberOfResults = $connection->prepare("SELECT * FROM user_details ");
    ...
    $numberOfResults = mysqli_num_rows($result);
     ...
     if(!isset($_GET['page'])){
      ...
      $totalPages = ceil($numberOfResults / $resultsPerPage) ;
        ...
        $query = "SELECT * FROM items LIMIT " . $resultsPerPage . " OFFSET " . ($page-1)*$resultsPerPage;
      ...
      <div class="pagination justify-content-center" style="text-align: center!important;">
            <?php
                        ...
                        if($page == $count){
                           // echo '<a style="color:black;" href="index.php?page='.$count.'">'.$count.'</a> ';
                            ...
                            <ul class="pagination">
                              ...
                              <li class="page-item"><a style="color:black;" class="page-link" href="index.php?page='.$count.'">'.$count.'</a></li>
                    ...
                    /*
                                  ...
                                  <ul class="pagination">
                                    ...
                                    <li class="page-item"><a class="page-link" href="index.php?page='.--$current.'">Previous</a></li>
                                  </ul>
                                </nav>';

                                  for($count = 1; $count<= $totalPages&&$count<=3; $count++){
                                      $mycount = $count;
                         ...
                         <ul class="pagination">
                           ...
                           <li class="page-item"><a  class="page-link" href="index.php?page='.$count.'">'.$count.'</a></li>
                                  ...
                                  <ul class="pagination">
                                    ...
                                    <li class="page-item"><a class="page-link" href="index.php?page='.++$current2.'">Next</a></li>
                                  </ul>
                                </nav>';
